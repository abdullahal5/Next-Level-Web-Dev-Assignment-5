...
const FeaturedRooms = () => {
  ...
  const images = [
    "https://i.ibb.co/1LSPG9m/luxury-bedroom-suite-resort-high-rise-hotel-with-working-table-105762-1783.jpg",
    "https://i.ibb.co/47LzhpB/umbrella-hammocks-pool-1203-174.jpg",
    "https://i.ibb.co/GHyNpyT/type-entertainment-complex-popular-resort-with-pools-water-parks-turkey-with-more-than-5-million-vis.jpg",
  ];
  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-center lg:flex-row md:flex-row flex-col gap-5">
          <div className="max-w-lg lg:mx-auto md:mx-auto flex flex-col md:flex-row shadow items-start overflow-hidden p-5 rounded-md gap-5 group bg-white border mx-5 lg:w-full md:w-full w-80">
            ...
            <div className="md:w-1/2 w-full lg:text-left md:text-left text-center flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-600 mt-2">Capacity: 06 people</p>
                <p className="text-gray-600 mt-2">Price Per Slot: $29</p>
              </div>
        ...
        <div className="flex pt-5 items-center justify-center lg:flex-row md:flex-row flex-col gap-5">
          <div className="max-w-lg lg:mx-auto md:mx-auto flex flex-col md:flex-row shadow items-start overflow-hidden p-5 rounded-md gap-5 group bg-white border mx-5 lg:w-full md:w-full w-80">
            <div className="flex-1 flex justify-center rounded-md overflow-hidden relative">
              <img
                src={images[activeImage]}
